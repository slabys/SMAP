...
def create_model():
    ...
    data = SubtractConstantLayer((224,224,3), name="data_")(data_unnormalized)
    ...
    fc = layers.Reshape((1, 1, -1), name="fc_preFlatten1")(pool5_drop_7x7_s1)
    fc = layers.Dense(8, name="fc_")(fc)
    prob = layers.Softmax()(fc)
    classoutput = layers.Flatten()(prob)

    model = keras.Model(inputs=[data_unnormalized], outputs=[classoutput])
    return model
